...
const ALL_SERVICES = [
  ...
  { slug: 'house-painting',          icon: '🎨', label: 'House Painting',            cat: 'painting' },
  { slug: 'furniture-painting',      icon: '🪑', label: 'Furniture Painting',        cat: 'painting' },
  { slug: 'house-lighting',          icon: '💡', label: 'House Lighting',            cat: 'painting' },
  { slug: 'house-wiring',            icon: '⚡', label: 'House Wiring',             cat: 'painting' },
  { slug: 'electrical-repairs',      icon: '🔌', label: 'Electrical Repairs',        cat: 'painting' },
  { slug: 'granite-countertops',     icon: '🪨', label: 'Granite Countertops',       cat: 'flooring' },
  { slug: 'landscaping-gardening',   icon: '🌿', label: 'Landscaping & Gardening',   cat: 'flooring' },
  { slug: 'carpentry-works',         icon: '🪵', label: 'Carpentry Works',           cat: 'painting' },
  { slug: 'debris-removal',          icon: '🚛', label: 'Debris Removal',            cat: 'painting' },
  { slug: 'demolition-work',         icon: '⚒️', label: 'Demolition Work',           cat: 'painting' },
  { slug: 'site-cleaning',           icon: '🧹', label: 'Site Cleaning',             cat: 'painting' },
...
const TABS = [
  ...
  { id: 'painting', label: 'Painting & More',   icon: '🎨', color: '#b45309', bg: '#fff7ed' },
]
