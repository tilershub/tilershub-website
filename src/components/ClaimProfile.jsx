    ...
    return (
      <div style={panelStyle}>
        ...
        <button
          ...
          disabled={loading}
          style={{ width: '100%', padding: '10px', background: loading ? '#94a3b8' : '#0F766E', color: '#fff', border: 'none', borderRadius: 10, fontSize: 13, fontWeight: 700, cursor: loading ? 'not-allowed' : 'pointer' }}
        >
  ...
  return (
    <div style={panelStyle}>
      ...
      <button
        ...
        style={{ width: '100%', padding: '10px', background: '#0F766E', color: '#fff', border: 'none', borderRadius: 10, fontSize: 13, fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}
      >
