...
const T = {
  si: {
    ...
    shareText: 'මම TilersHub හි ටයිලිං ව්‍යාපෘතියක් පලකළා — නොමිලේ ලංසු ලබාගන්න: https://tilershub.lk',
  ...
  en: {
    ...
    shareText: 'I just posted a tiling project on TilersHub — get free quotes: https://tilershub.lk',
