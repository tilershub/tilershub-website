...
const ALL_SERVICES_SI = [
  ...
  'ජිප්සම් සිවිලිම',
  // Phase 1–3
  'කුස් ප්‍රතිසංස්කරණය', 'වායු සමීකරණ', 'වහලය ඉදිකිරීම',
  'සෞරශක්ති පැනල', 'ප්ලාස්ටර් කිරීම', 'දොරටු සහ වැට',
  'CCTV ආරක්ෂාව', 'ඉෙපොක්සි ෆ්ලෝරිං', 'ලැමිනේට් ෆ්ලෝරිං',
  'ෆ්ලෝ බිත්ති', 'වතුර ටැංකිය', 'කුස් කැබිනට්',
  'කොන්ක්‍රීට් සහ ගෙඩිය', 'විනයිල් ෆ්ලෝරිං',
  'පිහිනුම් තටාකය', 'ස්මාර්ට් නිවස', 'ගෙල් සහ ගාල', 'ෆ්ෆේ ව',
]
